...
class Level {
    ...
    makeMove() {
        ...
        //		if goingToCollide:
        //			start moving pixel-by-pixel
        //			bounce off things as necessary
        //		else:
        //			move normally
        ...
        if (goingToCollide) {
        	...
        	this.playItem.y = Math.round(curY);
        } else {
        	this.playItem.move();
        }
